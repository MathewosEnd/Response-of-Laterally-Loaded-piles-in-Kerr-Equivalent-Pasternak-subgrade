...
import mesh
import os
from numpy import pi, sin, cos, genfromtxt
#----------------------------------------------------------------------------------------------------------------
...
workingDir = r'C:\Abaqus Thesis Files\Linearly Increasing Modulus\FxHFxB\eta_zero'
os.chdir(workingDir)

pData_file = 'Parameters_LIModulus_FxHFxB_eta_zero.csv'
...
for i in range(len(pData)):
    # Model name
    modelName = 'LIModulus_FxHFxB_eta_zero_Model_' + str(i)
    # Parameters
    pileRad = pData[i, 0]
