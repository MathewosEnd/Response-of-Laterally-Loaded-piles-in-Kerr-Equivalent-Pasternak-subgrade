...
def defineProperties_soil(modelName, materialName, sectionName, Esr, nu_s, domainDepth, pileLength):
    ...
    if slendernessRatio == 5:
        ...
        temp_dist[-1] = 3.125
        Es_dist = Esr*sqrt(temp_dist/pileRad)
        mdb.models[modelName].materials[materialName].Elastic(temperatureDependency=ON, table=((0.001, nu_s, temp_dist[0]), (Es_dist[1], nu_s, temp_dist[1]), (Es_dist[2], nu_s, temp_dist[2]), (Es_dist[3], nu_s, temp_dist[3]), (Es_dist[4], nu_s, temp_dist[4]), (Es_dist[5], nu_s, temp_dist[5]), (Es_dist[6], nu_s, temp_dist[6]), (Es_dist[7], nu_s, temp_dist[7]), (Es_dist[8], nu_s, temp_dist[8]), (Es_dist[9], nu_s, temp_dist[9]), (Es_dist[10], nu_s, temp_dist[10]), (Es_dist[11], nu_s, temp_dist[11]), (Es_dist[12], nu_s, temp_dist[12]), (Es_dist[13], nu_s, temp_dist[13]), (Es_dist[14], nu_s, temp_dist[14]), (Es_dist[15], nu_s, temp_dist[15]), (Es_dist[16], nu_s, temp_dist[16]), (Es_dist[17], nu_s, temp_dist[17])))
        ...
        temp_dist = hstack((temp_dist_0, temp_dist_1))
        Es_dist = Esr*sqrt(temp_dist/pileRad)
        mdb.models[modelName].materials[materialName].Elastic(temperatureDependency=ON, table=((0.001, nu_s, temp_dist[0]), (Es_dist[1], nu_s, temp_dist[1]), (Es_dist[2], nu_s, temp_dist[2]), (Es_dist[3], nu_s, temp_dist[3]), (Es_dist[4], nu_s, temp_dist[4]), (Es_dist[5], nu_s, temp_dist[5]), (Es_dist[6], nu_s, temp_dist[6]), (Es_dist[7], nu_s, temp_dist[7]), (Es_dist[8], nu_s, temp_dist[8]), (Es_dist[9], nu_s, temp_dist[9]), (Es_dist[10], nu_s, temp_dist[10]), (Es_dist[11], nu_s, temp_dist[11]), (Es_dist[12], nu_s, temp_dist[12]), (Es_dist[13], nu_s, temp_dist[13]), (Es_dist[14], nu_s, temp_dist[14]), (Es_dist[15], nu_s, temp_dist[15]), (Es_dist[16], nu_s, temp_dist[16]), (Es_dist[17], nu_s, temp_dist[17]), (Es_dist[18], nu_s, temp_dist[18]), (Es_dist[19], nu_s, temp_dist[19])))
        ...
        temp_dist[-1] = 4.375
        Es_dist = Esr*sqrt(temp_dist/pileRad)
        mdb.models[modelName].materials[materialName].Elastic(temperatureDependency=ON, table=((0.001, nu_s, temp_dist[0]), (Es_dist[1], nu_s, temp_dist[1]), (Es_dist[2], nu_s, temp_dist[2]), (Es_dist[3], nu_s, temp_dist[3]), (Es_dist[4], nu_s, temp_dist[4]), (Es_dist[5], nu_s, temp_dist[5]), (Es_dist[6], nu_s, temp_dist[6]), (Es_dist[7], nu_s, temp_dist[7]), (Es_dist[8], nu_s, temp_dist[8]), (Es_dist[9], nu_s, temp_dist[9]), (Es_dist[10], nu_s, temp_dist[10]), (Es_dist[11], nu_s, temp_dist[11]), (Es_dist[12], nu_s, temp_dist[12]), (Es_dist[13], nu_s, temp_dist[13]), (Es_dist[14], nu_s, temp_dist[14]), (Es_dist[15], nu_s, temp_dist[15]), (Es_dist[16], nu_s, temp_dist[16]), (Es_dist[17], nu_s, temp_dist[17]), (Es_dist[18], nu_s, temp_dist[18]), (Es_dist[19], nu_s, temp_dist[19]), (Es_dist[20], nu_s, temp_dist[20]), (Es_dist[21], nu_s, temp_dist[21]), (Es_dist[22], nu_s, temp_dist[22])))
        ...
        temp_dist = hstack((temp_dist_0, temp_dist_1))
        Es_dist = Esr*sqrt(temp_dist/pileRad)
        mdb.models[modelName].materials[materialName].Elastic(temperatureDependency=ON, table=((0.001, nu_s, temp_dist[0]), (Es_dist[1], nu_s, temp_dist[1]), (Es_dist[2], nu_s, temp_dist[2]), (Es_dist[3], nu_s, temp_dist[3]), (Es_dist[4], nu_s, temp_dist[4]), (Es_dist[5], nu_s, temp_dist[5]), (Es_dist[6], nu_s, temp_dist[6]), (Es_dist[7], nu_s, temp_dist[7]), (Es_dist[8], nu_s, temp_dist[8]), (Es_dist[9], nu_s, temp_dist[9]), (Es_dist[10], nu_s, temp_dist[10]), (Es_dist[11], nu_s, temp_dist[11]), (Es_dist[12], nu_s, temp_dist[12]), (Es_dist[13], nu_s, temp_dist[13]), (Es_dist[14], nu_s, temp_dist[14]), (Es_dist[15], nu_s, temp_dist[15]), (Es_dist[16], nu_s, temp_dist[16]), (Es_dist[17], nu_s, temp_dist[17]), (Es_dist[18], nu_s, temp_dist[18]), (Es_dist[19], nu_s, temp_dist[19]), (Es_dist[20], nu_s, temp_dist[20]), (Es_dist[21], nu_s, temp_dist[21]), (Es_dist[22], nu_s, temp_dist[22]), (Es_dist[23], nu_s, temp_dist[23]), (Es_dist[24], nu_s, temp_dist[24]), (Es_dist[25], nu_s, temp_dist[25]), (Es_dist[26], nu_s, temp_dist[26]), (Es_dist[27], nu_s, temp_dist[27]), (Es_dist[28], nu_s, temp_dist[28]), (Es_dist[29], nu_s, temp_dist[29]), (Es_dist[30], nu_s, temp_dist[30]), (Es_dist[31], nu_s, temp_dist[31]), (Es_dist[32], nu_s, temp_dist[32]), (Es_dist[33], nu_s, temp_dist[33]), (Es_dist[34], nu_s, temp_dist[34]), (Es_dist[35], nu_s, temp_dist[35]), (Es_dist[36], nu_s, temp_dist[36]), (Es_dist[37], nu_s, temp_dist[37]), (Es_dist[38], nu_s, temp_dist[38]), (Es_dist[39], nu_s, temp_dist[39]), (Es_dist[40], nu_s, temp_dist[40]), (Es_dist[41], nu_s, temp_dist[41]), (Es_dist[42], nu_s, temp_dist[42]), (Es_dist[43], nu_s, temp_dist[43]), (Es_dist[44], nu_s, temp_dist[44]), (Es_dist[45], nu_s, temp_dist[45]), (Es_dist[46], nu_s, temp_dist[46]), (Es_dist[47], nu_s, temp_dist[47]), (Es_dist[48], nu_s, temp_dist[48]), (Es_dist[49], nu_s, temp_dist[49]), (Es_dist[50], nu_s, temp_dist[50]), (Es_dist[51], nu_s, temp_dist[51]), (Es_dist[52], nu_s, temp_dist[52])))
...
def assignBC_PileHead_FX(modelName, setname, fxname):
    a = mdb.models[modelName].rootAssembly
    region = a.sets[setname]
    mdb.models[modelName].DisplacementBC(name=fxname, createStepName='Initial', region=region, u1=UNSET, u2=UNSET, u3=UNSET, ur1=SET, ur2=SET, ur3=SET, amplitude=UNSET, distributionType=UNIFORM, fieldName='', localCsys=None)
...
workingDir = r'C:\Abaqus Thesis Files\Parabolically Increasing Modulus\FxHFxB\eta_zero'
os.chdir(workingDir)

pData_file = 'Parameters_PBModulus_FxHFxB_eta_zero.csv'
...
for i in range(len(pData)):
    # Model name
    modelName = 'PBModulus_FxHFxB_eta_zero_Model_' + str(i)
    # Parameters
    pileRad = pData[i, 0]
    ...
    #
    # Domian size related
    # domainDepth = pileLength (Fixed Base pile)
    domainDepth = pileLength
    #
    ...
    # createConstraint_tie(modelName, surfRegion_s4, surfRegion_p4, 'Tie-4') #REMOVED as BASE TIED TO THE SOIL EXIHIBTED SLIGHTLY HIGHER STIFNESS COMPARED TO BVP FOR SHORT RIGID PILES
     #pile head surface for load application
    ...
    # Create Constraint to fix pile head
    refPoint1, refPoint_Loc1 = CreateRefPoint(modelName, 'HeadFx_RP', 0.0, 0.0, -0.5)
    createConstraint_Coupling(modelName, 'HeadFx_RP', 'pileHead_1', 'Coupling-1')
    createConstraint_Coupling(modelName, 'HeadFx_RP', 'pileHead_2', 'Coupling-2')
    assignBC_PileHead_FX(modelName, 'HeadFx_RP', 'PileHead_fx')
    # definition of sets
    ...
    createPSet_face(modelName, partName[1], 'mbaseFace_1', ((pileDia/4.0)*cos(3.0/4.0*pi))/2.0, -((pileDia/2.0)*sin(3.0/4.0*pi))/2.0, domainDepth)
    createPSet_face(modelName, partName[1], 'mbaseFace_2', ((pileDia/4.0)*cos(1.0/4.0*pi))/2.0, -((pileDia/2.0)*sin(1.0/4.0*pi))/2.0, domainDepth)
    ...
    createPSet_edge(modelName, partName[1], 'mbaseEdge_1', (pileDia/2.0)*cos(3.0/4.0*pi), -(pileDia/2.0)*sin(3.0/4.0*pi), domainDepth)
    createPSet_edge(modelName, partName[1], 'mbaseEdge_2', (pileDia/2.0)*cos(1.0/4.0*pi), -(pileDia/2.0)*sin(1.0/4.0*pi), domainDepth)
    createPSet_edge(modelName, partName[0], 'mSbaseEdge_1', (pileDia/2.0)*cos(3.0/4.0*pi), -(pileDia/2.0)*sin(3.0/4.0*pi), domainDepth)
    createPSet_edge(modelName, partName[0], 'mSbaseEdge_2', (pileDia/2.0)*cos(1.0/4.0*pi), -(pileDia/2.0)*sin(1.0/4.0*pi), domainDepth) 
    ...
    createPSet_edge(modelName, partName[1], 'mbaseEdge_4', -pileDia/4.0, 0.0, domainDepth)
    createPSet_edge(modelName, partName[1], 'mbaseEdge_5', pileDia/4.0, 0.0, domainDepth)
    #sets on the top
    ...
    #Fix the base of the domain
    baseFxsets = ['baseFace_1', 'baseFace_2', 'baseEdge_1', 'baseEdge_2', 'baseEdge_3', 'baseEdge_4', 'baseEdge_5', 'mSbaseEdge_1', 'mSbaseEdge_2']
    for m in range(len(baseFxsets)):
        assignBC_BaseFx(modelName, instanceName[0], baseFxsets[m], baseFxsets[m])
    #
    baseFxsets_1 = ['mbaseFace_1', 'mbaseFace_2',  'mbaseEdge_1', 'mbaseEdge_2', 'mbaseEdge_3', 'mbaseEdge_4', 'mbaseEdge_5']
    for f in range(len(baseFxsets_1)):
        assignBC_BaseFx(modelName, instanceName[1], baseFxsets_1[f], baseFxsets_1[f])
    #Fix the lateral sides
    latFxsets = ['backFace_1', 'backFace_2', 'topEdge_1', 'topEdge_2', 'backEdge_1']
    for n in range(len(latFxsets)):
        assignBC_lateralFx(modelName, instanceName[0], latFxsets[n], latFxsets[n])
    #Apply Y-symmetry 
    YsymmSets_1 = ['frontFace_1', 'frontFace_2', 'frontEdge_1', 'frontEdge_2', 'frontEdge_3', 'frontEdge_4', 'topEdge_4', 'topEdge_5']
    for o in range(len(YsymmSets_1)):
        assignBC_Ysymm(modelName, instanceName[0], YsymmSets_1[o], YsymmSets_1[o])
    YsymmSets_2 = ['pfrontFace_1', 'pfrontFace_2', 'ptopEdge_1', 'ptopEdge_2', 'pfrontEdge_1', 'pfrontEdge_2', 'pfrontEdge_3']
    ...
    #seed the vertical edges below the pile
