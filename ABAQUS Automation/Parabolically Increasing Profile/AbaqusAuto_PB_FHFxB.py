...
workingDir = r'C:\Abaqus Thesis Files\Parabolically Increasing Modulus\FHFxB\eta_zero'
os.chdir(workingDir)

pData_file = 'Parameters_PBModulus_FHFxB_eta_zero.csv'
...
for i in range(len(pData)):
    # Model name
    modelName = 'PBModulus_FHFxB_eta_zero_Model_' + str(i)
    # Parameters
    pileRad = pData[i, 0]
