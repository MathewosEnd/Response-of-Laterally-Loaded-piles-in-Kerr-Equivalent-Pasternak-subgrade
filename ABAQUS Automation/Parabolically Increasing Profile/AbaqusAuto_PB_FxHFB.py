...
workingDir = r'C:\Abaqus Thesis Files\Parabolically Increasing Modulus\FxHFB\eta_zero'
os.chdir(workingDir)

pData_file = 'Parameters_PBModulus_FxHFB_eta_zero.csv'
...
for i in range(len(pData)):
    # Model name
    modelName = 'PBModulus_FxHFB_eta_zero_Model_' + str(i)
    # Parameters
    pileRad = pData[i, 0]
    ...
    # Piramary (Pile) and secondary(Soil) regions exchanged to defined a coupling constraint to the pile head. If the pile was left as a secondary region this could not be done
    ...
    #Fix the base of the domain
    baseFxsets = ['baseFace_1', 'baseFace_2', 'mbaseFace_1', 'mbaseFace_2', 'baseEdge_1', 'baseEdge_2', 'mbaseEdge_1', 'mbaseEdge_2', 'baseEdge_3', 'mbaseEdge_3', 'baseEdge_4', 'baseEdge_5', 'mbaseEdge_4', 'mbaseEdge_5']
    ...
    #Apply Y-symmetry 
    YsymmSets_1 = ['frontFace_1', 'frontFace_2', 'frontFace_3', 'frontFace_4', 'frontEdge_1', 'frontEdge_2', 'frontEdge_3', 'frontEdge_4', 'frontEdge_5', 'frontEdge_6', 'frontEdge_7', 'frontEdge_8', 'frontEdge_9', 'frontEdge_10', 'mfrontEdge_6', 'mfrontEdge_7', 'topEdge_4', 'topEdge_5', 'mfrontFace_5', 'mfrontFace_6', 'mfrontEdge_2']
