...
baseName = '../Abaqus_Output/LIModulus_FHFB_eta_zero_Model_'; % FE output file
...
for j = 1:size(pData, 1)
    ...
    solBVP = bvp5c(@(z, u)Lin_govDiffEq(z, u, p), @(u0, uL) Lin_FHFB_BC(u0, uL, p), init_guess, opts);
...
writematrix(output, 'X_LIMod_FHFB.xlsx');
