...
baseName = '../Abaqus_Output/PBModulus_FHFxB_eta_zero_Model_'; % FE output file
...
for j = 1:size(pData, 1)
    ...
    solBVP = bvp5c(@(z, u) PB_govDiffEq(z, u, p), @(u0, uL) PB_FHFxB_BC(u0, uL, p), init_guess, opts);
...
writematrix(output, 'X_PBMod_FHFxB.xlsx');
